...
return [
    ...
    '77' => 'NOTE',
    '78' => '1. In any case, press and hold the Reset button for 5 seconds, the data on hard drives will be deleted! Please be cautious;',
    '79' => '2. Does not support hard drive hot swap;',
    '80' => '3. DONOT remove your hard drive while it is being accessed;',
    '81' => '4. Before you turn off your device or disconnect it from your computer, be sure to remove it and eject it safely. Otherwise, there is a risk of data loss;',
    '82' => '5. When you turn off the computer, hibernate the computer, eject the USB device, remove the USB connection, the device will automatically enter hibernation;',
    '83' => '6. Access the hard disk or connect USB again, the device will cancel hibernation;',
    '84' => 'Troubleshooting',
    '85' => 'The RAID manager recognizes the hard drives, but the computer does not, and no drive letter appears?',
    '86' => 'The computer does not recognize the hard drive and no drive letter appears?',
    '87' => 'If the hard drive indicator is off, please confirm whether the hard drive is installed properly, remove and insert the hard disk to try again;',
    '88' => 'If the hard drive indicator is orange, the hard drive may be faulty, please try to replace the hard drive;',
    '89' => 'Speed is very slow or even interrupted?',
    '90' => 'Use the original USB cable or replace a USB cable and try again;',
    '91' => 'Checking if it is the source is slow;',
    '92' => 'Checking whether you are using a USB 3.0 / USB3.1 high-speed interface;',
    '93' => 'Ramdomly disconnect from computer?',
    '94' => 'Try other computer\'s USB interface;',
    '95' => 'Make sure Connection is not after a USB hub or a Docking;',
    '96' => 'Reinstall the official USB interface driver provided by the computer manufacturer;',
    '97' => 'Replace a hard drive and try again;',
    '98' => 'Failed to create a RAID?',
    '99' => 'Step 1: Rotate the switch’s pointer to SINGLE mode;',
    '100' => 'Step 2: Press and hold the Reset button for about 5 seconds until the HDD indicators turn to red from green;',
    '101' => 'Step 3: After about 1 second, the HDD indicators turn to green from red, rotate the switch’s pointer to your desired RAID mode;',
    '102' => 'Step 4: Press and hold the Reset button for about 5 seconds until the HDD indicators turn to red from green;',
    '103' => 'Step 5: After about 2 seconds, the HDD indicators turn to green from red, the RAID creation is complete.',
    '104' => 'NEED HELP?',
    '105' => 'Download user manual；',
    '106' => 'https://dl.terra-master.com/en/TerraMaster_User_Manual_for_D2-310_en.zip',
    '107' => 'Get support, such as: video guides, TOS help, FAQ, downloads, compatibility, registered products；',
    '108' => 'If you need help, please contact us.',
];
